...
ActiveRecord::Schema.define(version: 2021_12_01_135656) do
  ...
  create_table "currencies", force: :cascade do |t|
    ...
    t.float "current_euro_value", default: 0.0, null: false
    t.string "logo_url", default: "https://s3.us-east-2.amazonaws.com/nomics-api/static/images/currencies/btc.svg", null: false
  end
